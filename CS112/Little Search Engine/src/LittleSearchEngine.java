...
public class LittleSearchEngine {
     ...
     * @throws java.io.FileNotFoundException If there is a problem locating any of the input files on disk
     */
     ...
     * @throws java.io.FileNotFoundException If the document file is not found on disk
     */
...
//    private Occurrence search(ArrayList<String> document, ArrayList<Occurrence> occurrence) {
//        if (occurrence != null) {
//            for (Occurrence occ : occurrence) {
//                if (!document.contains(occ.document)) {
//                    return occ;
//                }
//            }
//        }
