...
// rev 3: traverse changed to print null, append fixed, addAtBack added
...
public class LLApp{
	...
	public static void main(String[] args) {
		...
		l1 = append(l1, l2);   // rev 3
		traverse(l1);
		
		deleteNode(l1, n1);
		traverse(l1);

		System.out.println("==============================");// rev 3 from here
		
		traverse(null);
		l1 = null;  
		l2 = addAtFront(null, 50);
		l2 = addAtFront(l2, 60);
		traverse(l2);
		l1 = append(l1, l2);
		traverse(l1);                                 // rev3 to here		
	}
	...
	public static void traverse(IntNode front) {
		if (front == null) {
		    System.out.println("null");   // changed rev 3
		} else {
    ...
    public static IntNode append(IntNode a, IntNode b){  // rev 3
	if (a == null){
	    return b;
	} else {
	last(a).next = b;
