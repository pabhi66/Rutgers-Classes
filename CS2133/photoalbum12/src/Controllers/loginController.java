...
//
//  /**
//   * login button, if admin logs in, it takes us to admin window, otherwise user window
//   * @param event
//     */
...
//          stage.show();
//      }else if(usernameText.getText() == "" || passwordText.getText() == ""){
//          errorLabel.setText("Enter username and password");
//      }else{
//          if(!(controller.loginCheck(usernameText.getText(),passwordText.getText()))){
//              errorLabel.setText("username or password is incorrect");
//              refresh();
//          }
//          else{
//              ((Node) (event.getSource())).getScene().getWindow().hide();
//              writeToFile(UNAME,"login.txt");
//              parent = FXMLLoader.load(getClass().getResource("user.fxml"));
//              Stage stage = new Stage();
//              Scene scene = new Scene(parent);
//              stage.setResizable(false);
//              stage.setScene(scene);
...
//            errorLabel.setText("Enter UserID and Password");
//        }
//        else if(!controller.adduser(usernameText.getText(),passwordText.getText())){
//            refresh();
...
//    }
//
//  private void writeToFile(String id, String filename){
//    try{
