...
//                            imageView.setBorder(new Border(new BorderStroke(Color.GRAY, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(1))));
    ...
    public void setAutoTagButton(ActionEvent actionEvent) throws Exception {
        ...
        if(currentPhotoSelected == null){
            ...
            try {
                ...
                vision = this.getVisionService();
                String im = "data/photos/" + currentPhotoSelected;
                Path imagePath = Paths.get(im);

                ArrayList<String> tags=getTags( imagePath, labelImage(imagePath, MAX_LABELS));
                String joined = String.join(",", tags);

                Alert alert = new Alert(Alert.AlertType.CONFIRMATION,"Do you want to add these tags?",ButtonType.YES, ButtonType.NO);
                ...
                if (alert.getResult() == ButtonType.YES) {
                    ...
                    if(tags.size()>0){
                        ...
                        for (int i=0;i<tags.size();i++){
                            controller.addTag(currentPhotoSelected,tags.get(i));
                        }
                        Map<String, Album2> albumHash = currentuser.getAlbumss();
                        Album2 targetAlbum = albumHash.get(ANAME);
                        targetAlbum.changeDate();
    ...
    private static final String API_KEY = "AIzaSyC5UBN2kwQQLHCo-j_uRC6Y1cKQYQnzbh8";
    private static final String APPLICATION_NAME = "PhotoAlbum31";
     ...
     */
    public static ArrayList<String > getTags(Path imagePath, List<EntityAnnotation> labels) {
