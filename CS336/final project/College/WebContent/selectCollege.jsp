...
<body>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Select College</h1>
                <hr>
                <p>We have found these colleges based on your search.  Click on College to learn more about it.</p>
	...
	try {
		...
		out.print("<center><p>We found this Colleges based on your search.  Please click on the college to learn more about it.</p></center>");
