...
<body>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Select Your Budget</h1>
                <hr>
                <p>Select the cost so we can find the top colleges based on your budget.</p>
    ...
    <center><form method="query" action="average.jsp">
   
						
						
							<p>1)What is <b class='accent'>Your </b> <b class='accent'>Budget</b><br>
						<select name="Price" size=1>
						<option value="fee">Tuition Cost</option>
