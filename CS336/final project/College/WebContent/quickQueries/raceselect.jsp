...
<body>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <p>Select the state and race so we can find the top colleges for you..</p>
    ...
    <center><form method="query" action="race.jsp">
    <p>1) Click your <b class="accent">state</b>  or <b class='accent'>territory</b><br>
						<select name="State" size=1>
							...
							<p>2)What is <b class='accent'>Your </b> <b class='accent'>Race</b><br>
						<select name="Race" size=1>
						<option value="BORN_US">US Born</option>
							<option value="UNDERGRADUATE_WHITE">White</option>
							<option value="UNDERGRADUATE_BLACK">Black</option>
							<option value="UNDERGRADUATE_HISPANIC">Hispanic</option>
							<option value="UNDERGRADUATE_ASIAN">Asian</option>
							<option value="UNDERGRADUATE_AIAN">Aian</option>
							<option value="UNDERGRADUATE_NHPI">Nhpi</option>
						</select>
