...
<body>
    ...
    <header>
        <div class="header-content">
            ...
            <% 
            int pricee = Integer.parseInt(request.getParameter("Price"));
                out.print("<h1 id=\"homeHeading\">Top College with Average Tuition cost of" +  pricee + " </h1>"); %>
                <hr>
                <p>Digging through the database to find the best colleges that costs around $20000<br></p>
	...
	try {
		...
		String str = "select * from my_project1.acceptanceRate as r,my_project1.College_Cost as c  where c.College=r.College and c.Tuition_Cost_IN<=" + (price + 2000) + " and c.Tuition_Cost_IN>=" +  (price-2000) + " order by  Acceptance_Rate asc limit 10 ;";
		ResultSet result = stmt.executeQuery(str);
		
		out.print("<form method=\"searchhh\" action=\"searchCollege.jsp\">");
		 //Make an HTML table to show the results in:
		out.print("<center><p>Top Colleges with Average $20000 tuition cost</p></center>");
		...
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Tuitin cost in-state</center>");
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Tuition cost out-state</center>");
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Living cost</center>");
		out.print("</td>");
		out.print("</tr>");
