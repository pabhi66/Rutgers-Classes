        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
            		...
            		<form method="searchh" action="selectCareer2.jsp">
						<p>Enter Major Name to Find all its information</p>
							<table>
								<tr> 
								<center><td>Enter Major Name: &nbsp; &nbsp;</td><td><input type="text" name="major STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #FFFFFF;" size="50" maxlength="100"></td>
