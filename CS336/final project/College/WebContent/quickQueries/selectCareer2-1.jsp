...
<body>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <p>We have found these Major based on your search.  Click on Major to learn more about it.</p>
	...
	try {
		...
		String str = "SELECT distinct Major FROM my_project1.majorSalary WHERE Major LIKE " + "'%" + major + "%'";
		...
		out.print("<center><p>We found this Major based on your search.  Please click on the Major to learn more about it.</p></center>");
		...
		while (result.next()){
            ...
            out.print("<a href=\"CareerPay-1.jsp?item=");
