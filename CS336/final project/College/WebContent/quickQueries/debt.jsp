...
<body>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Debt</h1>
                <hr>
                <p>Digging through the database to find which college has the highest debt after graduation.<br></p>
	...
	try {
		...
		String str = "SELECT * FROM my_project1.`all` order by DEBT_MDN desc limit 10;";
		ResultSet result = stmt.executeQuery(str);
		
		out.print("<form method=\"searchhh\" action=\"searchCollege.jsp\">");
		 //Make an HTML table to show the results in:
		out.print("<center><p>Top 10 college's with the most student debt</p></center>");
		...
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Average Undergrad Debt</center>");
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Average grad Debt</center>");
		out.print("</td>");
		out.print("<td>");
		out.print("<center>Female who has Debt</center>");
		out.print("</td>");
		out.print("<td>");
		out.print("<center>male who has Debt</center>");
		out.print("</td>");
		out.print("</tr>");
