...
<body>
        ...
        <div class="header-content">
          ...
          //Create a connection string
            ...
            %>
                ...
                <hr>
                <p>Cutting through government data to find the top Colleges for you by state and your race.  The top Colleges are based on your race.</p>
	...
	try {
		...
		String rate = request.getParameter("Race");
		String str;
	
			str = "select s1.College,s1."+rate+" from (select * from my_project1.all as a,my_project1.race as s where a.College=s.SCHOOL_NAME)s1 where s1.State = " + "\"" + state + "\"" + " and "+rate+" <> 1 order by "+rate+" desc limit 10";
		...
		out.print("<center><p>Here are the top 10 colleges by chosen state and race.</p></center>");
		...
		while (result.next()){
            ...
            out.print(result.getString("s1.College"));
            out.print("\"style=\"color: #FFFFFF\">");
            out.print(result.getString("s1.College"));
            out.print("</td>");
            out.print("<td height=\"50\">");
            out.print(result.getString("s1."+rate));
            out.print("</td>");
